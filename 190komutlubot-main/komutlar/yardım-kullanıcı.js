...
.addField(`<:sagok:778774307253518366> __Profil Resmi__`,` \`s*pp\` Avatarınızı Atar`,true)
.addField(`<:sagok:778774307253518366> __Tavsiye__`,` \`s*tavsiye\` Biz Yapımcılara Tavsiye Verirsiniz.`,true)
...
.addField(`<:sagok:778774307253518366> __Mesaj Sayacı__`,` \`s*mesaj-sayar\` Toplam Mesaj Sayınızı Gösterir.`,true)
.addField(`<:sagok:778774307253518366> __Resim Sayacı__`,` \`s*resim-sayar\` Toplam Resim Sayınızı Gösterir.`,true)
.addField(`<:sagok:778774307253518366> __Küfür Sayacı__`,` \`s*küfür-sayar\` Toplam Küfür Sayınızı Gösterir.`,true)
.addField(`<:sagok:778774307253518366> __Reklam Sayacı__`,` \`s*reklam-sayar\` Toplam Reklam Sayınızı Gösterir.`,true)
.addField(`<:sagok:778774307253518366> __Kullanıcı Bilgi__`,` \`s*kullanıcı-bilgi <@üye>\` Kullanıcı'nın Bilgilerini Gösterir.`,true)
.addField(`<:sagok:778774307253518366> __Sunucu Bilgi__`,` \`s*sunucu-bilgi\` Sunucu'nun Bilgilerini Gösterir.`,true)
